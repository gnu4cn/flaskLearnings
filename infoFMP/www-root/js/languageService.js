    ...
    function languageService(getLocale) {
        return function () {
            ...
            languagesData['zh-cn'] = {
                ...
                PassportNumberHelp: '仅包含大写字母和数字，14 位',
                IdNumberNotQualified: '身份证号码不正确',
                PassportNumberNotQualified: '护照号码不正确。',
                NextStep: '下一步 》',
                firstName: '姓氏',               
                lastName: '名称',
                firstNameHelp: '姓名中的第一个或第二个汉字。',
                PleaseInputaFirstname: '请输入您的姓氏',
                PleaseInputaLastname: '请输入您的名字',
                FirstnameContainSpecialCharactors: '姓氏中包含了特殊字符。',
                LastnameContainSpecialCharactors: '名字中包含了特殊字符。',
                lastNameHelp: '您的名字。',
                PleaseSetAPassword: '请提供一个密码'
            };
            languagesData['en'] = {
                PleaseSetAPassword: 'Please provide a password',
                LastnameContainSpecialCharactors: 'last name contains special charactors.',
                FirstnameContainSpecialCharactors: 'First name contains special charactors.',
                PleaseInputaLastname: 'Your last name',
                PleaseInputaFirstname: 'Your first name',
                firstNameHelp: 'First name or given name.',
                lastNameHelp: 'Last name or family name.',
                firstName: 'First name',            
                lastName: 'Last name',
                NextStep: 'Next >>',
                IdNumberNotQualified: 'ID number not qualified.',
                PassportNumberHelp: 'Only include upper case alphabets and digits, 14 of them.',
                IDNumberHelp: '18 digits, or 17 digits and a X as trailing end.',
                YourPassportNumber: 'Your Passport number',
            ...
            return languagesData[getLocale()];
        };
